    ...
    private class Robot {
        ...
        private void drawLowerArm() {
            ...
            if (gs.showStick) {
                ...
                drawing a total of 180 triangles in a for loop, using some basic geometry to determine the position
...
//            final double
//            for (double t = 0; t <= 1.0d; t += dt) {
//                Vector center = getPoint(t);
//                Vector toOrigin = Vector.Z.cross(center).normalized();
//
//                Vector innerPoint = center.add(toOrigin.scale(2));
//                Vector outerPoint = center.add(toOrigin.scale(-2));
//
//
//            }
//        }
